...
<section class="hero-carousel">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <?php foreach ($carousel_slides as $index => $slide): ?>
                <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php echo SITE_URL . '/' . $slide['image_path']; ?>') center center / cover no-repeat;">
                    <div class="carousel-caption text-center">
                        ...
                        <?php if (!empty($slide['button_text']) && !empty($slide['button_link'])): ?>
                            <a href="<?php echo $slide['button_link']; ?>" class="btn btn-primary animate__animated animate__fadeInUp"><?php echo $slide['button_text']; ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title text-center">
                    <h2>Why Choose Us</h2>
                    <p>We provide innovative IT solutions tailored to meet the unique needs of businesses, schools, and educational institutions.</p>
                </div>
            </div>
        </div>
        <div class="row g-4">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title text-center">
                    <h2>Our Services</h2>
                    <p>We offer a wide range of educational technology solutions to help schools and institutions thrive in the digital age.</p>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="service-card">
                            ...
                            <?php if (!empty($service['image'])): ?>
                                <div class="service-image mt-3">
                                    <img src="<?php echo SITE_URL . '/' . $service['image']; ?>" alt="<?php echo $service['title']; ?>" class="img-fluid rounded">
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <?php else: ?>
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="zoom-in">
                    <div class="service-card">
                        ...
                        <p>Integrated hardware and software systems designed to create engaging, interactive learning environments.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="service-card">
                        ...
                        <p>Comprehensive digital platforms that streamline administrative tasks and improve communication.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="service-card">
                        ...
                        <p>Data-driven tools that help educators understand student progress and personalize instruction.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        <div class="text-center mt-4" data-aos="fade-up">
            <a href="<?php echo SITE_URL; ?>/about.php#services" class="btn btn-outline-primary">Learn More About Our Services</a>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="testimonial-card h-100 bg-white p-4 rounded shadow-sm">
                        ...
                        <div class="testimonial-text mb-4">
                            <p class="fst-italic">"FLIONE has transformed our school's technology infrastructure. Our students are more engaged, and our teachers have the tools they need to deliver exceptional education."</p>
                        </div>
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image me-3">
                                <img src="<?php echo SITE_URL; ?>/assets/images/testimonials/principal.jpg" alt="Sarah Johnson" class="rounded-circle" width="60" height="60">
                            </div>
                            <div class="author-info">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="testimonial-card h-100 bg-white p-4 rounded shadow-sm">
                        ...
                        <div class="testimonial-text mb-4">
                            <p class="fst-italic">"The implementation process was seamless, and the ongoing support has been exceptional. FLIONE truly understands the unique challenges schools face with technology integration."</p>
                        </div>
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image me-3">
                                <img src="<?php echo SITE_URL; ?>/assets/images/testimonials/it-director.jpg" alt="Michael Chen" class="rounded-circle" width="60" height="60">
                            </div>
                            <div class="author-info">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="testimonial-card h-100 bg-white p-4 rounded shadow-sm">
                        ...
                        <div class="testimonial-text mb-4">
                            <p class="fst-italic">"As a teacher, I appreciate how FLIONE's solutions are designed with the classroom in mind. The technology enhances my teaching without getting in the way."</p>
                        </div>
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image me-3">
                                <img src="<?php echo SITE_URL; ?>/assets/images/testimonials/teacher.jpg" alt="Emily Rodriguez" class="rounded-circle" width="60" height="60">
                            </div>
                            <div class="author-info">
                        ...
                        <div class="blog-card">
                            <div class="blog-img">
                                <?php if (!empty($post['featured_image'])): ?>
                                    <img src="<?php echo SITE_URL . '/' . $post['featured_image']; ?>" alt="<?php echo $post['title']; ?>">
                                <?php else: ?>
                                    <img src="<?php echo SITE_URL; ?>/assets/images/blog/blog-default.jpg" alt="<?php echo $post['title']; ?>">
                                <?php endif; ?>
                            ...
                            <div class="blog-content">
                                <div class="blog-date">
                                    ...
                                    <?php if (!empty($post['author_name'])): ?>
                                        <span class="ms-3"><i class="far fa-user me-2"></i><?php echo $post['author_name']; ?></span>
                                    <?php endif; ?>
                                </div>
                                <h4><?php echo $post['title']; ?></h4>
                                <p><?php echo !empty($post['excerpt']) ? $post['excerpt'] : create_excerpt($post['content']); ?></p>
                                <a href="<?php echo SITE_URL; ?>/blog-post.php?slug=<?php echo $post['slug']; ?>" class="blog-link">Read More <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
...
<section class="clients-section py-5 bg-light">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-2 col-md-4 col-6 text-center mb-4" data-aos="zoom-in">
                <img src="<?php echo SITE_URL; ?>/assets/images/clients/client-1.png" alt="Client" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-4 col-6 text-center mb-4" data-aos="zoom-in" data-aos-delay="100">
                <img src="<?php echo SITE_URL; ?>/assets/images/clients/client-2.png" alt="Client" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-4 col-6 text-center mb-4" data-aos="zoom-in" data-aos-delay="200">
                <img src="<?php echo SITE_URL; ?>/assets/images/clients/client-3.png" alt="Client" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-4 col-6 text-center mb-4" data-aos="zoom-in" data-aos-delay="300">
                <img src="<?php echo SITE_URL; ?>/assets/images/clients/client-4.png" alt="Client" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-4 col-6 text-center mb-4" data-aos="zoom-in" data-aos-delay="400">
                <img src="<?php echo SITE_URL; ?>/assets/images/clients/client-5.png" alt="Client" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-4 col-6 text-center mb-4" data-aos="zoom-in" data-aos-delay="500">
