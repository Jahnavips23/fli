<?php
// Include the admin config file which already includes the main config
...
try {
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS client_inquiry_notes (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS inquiry_sources (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS inquiry_types (
        id INT AUTO_INCREMENT PRIMARY KEY,
        name VARCHAR(100) NOT NULL,
        display_order INT NOT NULL DEFAULT 0,
        is_active TINYINT(1) NOT NULL DEFAULT 1,
    ...
    $db->exec("INSERT INTO inquiry_sources (name, display_order) VALUES 
        ('IndiaMart', 1),
        ('Website', 2),
        ('Referral', 3),
        ('Social Media', 4),
    ...
    $db->exec("INSERT INTO inquiry_types (name, display_order) VALUES 
    ...
    $db->exec("INSERT INTO email_templates (name, subject, body, is_default) VALUES 
