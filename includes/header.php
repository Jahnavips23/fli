...
<meta property="og:title" content="Interactive White Digital Board and Interactive LED Panel OEM Manufacturer | Bengaluru">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <span class="ms-3"><i class="fas fa-phone me-2"></i><?php echo get_setting('contact_phone'); ?></span>
                </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo SITE_URL; ?>">
                    <img src="<?php echo SITE_URL; ?>/assets/images/logo/logo.png" alt="<?php echo SITE_NAME; ?>" height="50">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('index') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('about') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/about.php">About Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('for-schools') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/for-schools.php">For Schools</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('for-kids') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/for-kids.php">For Kids</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('blog') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/blog.php">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('downloads') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/downloads.php">Downloads</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('careers') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/careers.php">Careers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo is_active_page('track') ? 'active' : ''; ?>" href="<?php echo SITE_URL; ?>/track.php">
