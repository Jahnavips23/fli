    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0 kids-intro-content" data-aos="fade-right">
                ...
                <p>At Flione IT, we believe that technology education should be fun, engaging, and accessible to
                    children of all ages. Our specially designed programs introduce kids to coding, robotics, digital
                    art, and more in a supportive and creative environment.</p>
                <p>Led by experienced instructors who are passionate about technology and education, our programs help
                    children develop critical thinking, problem-solving skills, and digital literacy while fostering
                    creativity and collaboration.</p>
                <div class="mt-4 d-flex gap-3 flex-wrap">
                    <a href="#programs" class="btn btn-primary btn-rect">Explore Our Programs</a>
                    <a href="#products" class="btn btn-success btn-rect">Shop Educational Products</a>
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
                <img src="<?php echo SITE_URL; ?>/assets/images/kids-learning.jpg" alt="Kids Learning Technology"
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                ...
                <p class="section-description">Discover our range of exciting technology programs designed specifically
                    for children</p>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <?php if (!empty($programs)): ?>
                <?php foreach ($programs as $index => $program): ?>
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo $index * 100; ?>">
                        <div class="card h-100 program-card">
                            <?php if (!empty($program['image'])): ?>
                                <img src="<?php echo SITE_URL . '/' . $program['image']; ?>" class="card-img-top"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <small class="text-muted d-block"><i class="fas fa-clock me-1"></i>
                                                <?php echo $program['duration']; ?></small>
                                        </div>
                                        <div class="col-6 text-end">
                                            <?php if ($program['price'] > 0): ?>
                                                <small
                                                    class="text-primary fw-bold">₹<?php echo number_format($program['price'], 2); ?></small>
                                            <?php else: ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <a href="#" class="btn btn-sm btn-outline-primary view-program-details"
                                        data-bs-toggle="modal" data-bs-target="#programModal<?php echo $program['id']; ?>">View
                                        Details</a>
                                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#registerModal"
                                        onclick="selectProgram(<?php echo $program['id']; ?>)">Register</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Program Modal -->
                    <div class="modal fade" id="programModal<?php echo $program['id']; ?>" tabindex="-1"
                        aria-labelledby="programModalLabel<?php echo $program['id']; ?>" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="programModalLabel<?php echo $program['id']; ?>">
                                        <?php echo $program['title']; ?></h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-4 mb-md-0">
                                            <?php if (!empty($program['image'])): ?>
                                                <img src="<?php echo SITE_URL . '/' . $program['image']; ?>"
                                                    class="img-fluid rounded" alt="<?php echo $program['title']; ?>">
                                            <?php else: ?>
                                            ...
                                            <div class="program-details mt-3">
                                                ...
                                                <?php if ($program['price'] > 0): ?>
                                                    ...
                                                    <p class="text-primary fw-bold">
                                                        ₹<?php echo number_format($program['price'], 2); ?></p>
                                                <?php endif; ?>

                                                <?php if ($program['start_date'] && $program['end_date']): ?>
                                                    <p class="mb-1"><strong>Dates:</strong></p>
                                                    <p><?php echo date('F j, Y', strtotime($program['start_date'])); ?> -
                                                        <?php echo date('F j, Y', strtotime($program['end_date'])); ?></p>
                                                <?php endif; ?>
                                            ...
                                            if (!empty($program_gallery)):
                                                ...
                                                <div class="row g-2 mb-4">
                                                    <?php foreach ($program_gallery as $item): ?>
                                                        <div class="col-6">
                                                            <a href="<?php echo SITE_URL . '/' . $item['image']; ?>"
                                                                data-lightbox="program-<?php echo $program['id']; ?>"
                                                                data-title="<?php echo $item['title']; ?>">
                                                                <img src="<?php echo SITE_URL . '/' . $item['image']; ?>"
                                                                    alt="<?php echo $item['title']; ?>" class="img-fluid rounded">
                                                            </a>
                                                        </div>
                                                    <?php endforeach; ?>
                                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary register-from-modal"
                                        data-program-id="<?php echo $program['id']; ?>">Register Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center">
                        <p>No programs available at the moment. Please check back later or contact us for more information.
                        </p>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                ...
                <p class="section-description">Discover our range of educational technology products designed to inspire
                    young minds</p>
            </div>
        </div>
        ...
        <div class="row mt-5">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo $index * 100; ?>">
                        <div class="card h-100 product-card">
                            <?php if (!empty($product['image'])): ?>
                                <img src="<?php echo SITE_URL . '/' . $product['image']; ?>" class="card-img-top"
                            ...
                            <div class="card-body">
                                ...
                                <div class="product-price mt-3">
                                    <?php if ($product['sale_price'] > 0): ?>
                                        <span
                                            class="text-decoration-line-through text-muted me-2">₹<?php echo number_format($product['price'], 2); ?></span>
                                        <span
                                            class="text-danger fw-bold">₹<?php echo number_format($product['sale_price'], 2); ?></span>
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary inquire-btn"
                    ...
                    <div class="modal fade" id="productModal<?php echo $product['id']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                        ...
                                        <div class="col-md-5 mb-4 mb-md-0">
                                            <?php if (!empty($product['image'])): ?>
                                                <img src="<?php echo SITE_URL . '/' . $product['image']; ?>"
                                                    class="img-fluid rounded" alt="<?php echo $product['title']; ?>">
                                            <?php else: ?>
                                                <div class="bg-light text-center py-5 rounded">
                                            ...
                                            <div class="product-details mt-3">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <div>
                                                        <span
                                                            class="badge bg-primary"><?php echo $product['category']; ?></span>
                                                ...
                                                <div class="product-price mb-3">
                                                    <?php if ($product['sale_price'] > 0): ?>
                                                        <span
                                                            class="text-decoration-line-through text-muted me-2">₹<?php echo number_format($product['price'], 2); ?></span>
                                                        <span
                                                            class="text-danger fw-bold fs-4">₹<?php echo number_format($product['sale_price'], 2); ?></span>
                                                        <span class="badge bg-danger ms-2">SALE</span>
                                                    <?php elseif ($product['price'] > 0): ?>
                                                        <span
                                                            class="fw-bold fs-4">₹<?php echo number_format($product['price'], 2); ?></span>
                                                    <?php else: ?>
                                                        <span class="text-muted">Contact for pricing</span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="d-grid gap-2">
                                                    <a href="mailto:<?php echo SITE_EMAIL; ?>?subject=Order inquiry for <?php echo urlencode($product['title']); ?>&body=I am interested in ordering the <?php echo urlencode($product['title']); ?>. Please provide more information."
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-primary inquire-btn" data-bs-toggle="modal"
                                        data-product-id="<?php echo $product['id']; ?>"
                                        data-product-title="<?php echo htmlspecialchars($product['title']); ?>">
                                        Order Now
                                    </button>
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center">
                        <p>No products available at the moment. Please check back later or contact us for more information.
                        </p>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="row mt-5 kids-features">
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
                <div class="feature-box">
                    ...
                    <p>Our programs are led by experienced educators who specialize in teaching technology to children
                        and know how to make learning fun and engaging.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div class="feature-box">
                    ...
                    <p>We maintain small class sizes to ensure each child receives personalized attention and support
                        throughout their learning journey.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-box">
                    ...
                    <p>Children learn by doing in our programs, with hands-on projects and activities that reinforce
                        concepts and make learning memorable.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                <div class="feature-box">
                    ...
                    <p>Our curriculum is carefully designed to match the developmental needs and interests of different
                        age groups, ensuring an optimal learning experience.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="400">
                <div class="feature-box">
                    ...
                    <p>Children have the opportunity to showcase their projects and achievements, building confidence
            ...
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="500">
                <div class="feature-box">
                    ...
                    <p>We provide a safe, supportive, and inclusive learning environment where children feel comfortable
                        exploring, experimenting, and expressing themselves.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="gallery-container">
                    <?php foreach ($gallery_items as $index => $item): ?>
                        <div class="gallery-item" data-aos="fade-up" data-aos-delay="<?php echo ($index % 6) * 100; ?>">
                            <a href="<?php echo SITE_URL . '/' . $item['image']; ?>" data-lightbox="program-gallery"
                                data-title="<?php echo $item['title']; ?> - <?php echo $item['program_title']; ?>">
                                <img src="<?php echo SITE_URL . '/' . $item['image']; ?>" alt="<?php echo $item['title']; ?>"
                                    class="img-fluid">
            ...
            <div class="modal-body">
                <?php if ($inquiry_submitted && $inquiry_success): ?>
                    <div class="alert alert-success">
                        ...
                        <p>Thank you for your interest in our product. We have received your inquiry and will contact you
                            shortly.</p>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <form action="<?php echo SITE_URL; ?>/for-kids.php" method="post" class="inquiry-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control <?php echo isset($inquiry_errors['name']) ? 'is-invalid' : ''; ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email"
                                class="form-control <?php echo isset($inquiry_errors['email']) ? 'is-invalid' : ''; ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea
                                class="form-control <?php echo isset($inquiry_errors['message']) ? 'is-invalid' : ''; ?>"
                            ...
                            <?php endif; ?>
                            <small class="form-text text-muted">Please include any specific questions or requirements you
                                have about the product</small>
                        </div>
            ...
            <div class="modal-body">
                <?php if ($form_submitted && $form_success): ?>
                    <div class="alert alert-success">
                        ...
                        <p>Thank you for registering for our program. We have received your information and will contact you
                            shortly with further details.</p>
                        <?php if (isset($waitlisted)): ?>
                            <hr>
                            <p class="mb-0">Note: The program you selected is currently full. Your registration has been added
                                to our waitlist, and we will contact you if a spot becomes available.</p>
                        <?php endif; ?>
                    </div>
                    <div class="text-center mt-4">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Close</button>
                ...
                <?php else: ?>
                    ...
                    <form action="<?php echo SITE_URL; ?>/for-kids.php" method="post" class="registration-form">
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                <label for="program_id" class="form-label">Select Program <span
                                        class="text-danger">*</span></label>
                                <select
                                    class="form-select <?php echo isset($form_errors['program_id']) ? 'is-invalid' : ''; ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    <label for="child_name" class="form-label">Child's Full Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text"
                                        class="form-control <?php echo isset($form_errors['child_name']) ? 'is-invalid' : ''; ?>"
                                        id="child_name" name="child_name"
                                        value="<?php echo isset($child_name) ? htmlspecialchars($child_name) : ''; ?>"
                                        required>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="child_age" class="form-label">Child's Age <span
                                            class="text-danger">*</span></label>
                                    <input type="number"
                                        class="form-control <?php echo isset($form_errors['child_age']) ? 'is-invalid' : ''; ?>"
                                        id="child_age" name="child_age" min="1" max="18"
                                        value="<?php echo isset($child_age) && $child_age > 0 ? $child_age : ''; ?>"
                                        required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                <label for="parent_name" class="form-label">Parent/Guardian Name <span
                                        class="text-danger">*</span></label>
                                <input type="text"
                                    class="form-control <?php echo isset($form_errors['parent_name']) ? 'is-invalid' : ''; ?>"
                                    id="parent_name" name="parent_name"
                                    value="<?php echo isset($parent_name) ? htmlspecialchars($parent_name) : ''; ?>"
                                    required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="special_requirements" name="special_requirements"
                                    rows="4"
                                    placeholder="Please let us know about any special requirements, allergies, or other information that would help us provide the best experience for your child."><?php echo isset($special_requirements) ? htmlspecialchars($special_requirements) : ''; ?></textarea>
                            </div>
                        </div>

                        <div class="text-center mt-4">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" name="submit_registration" class="btn btn-primary">Submit
                                Registration</button>
                        </div>
                    </form>
                <?php endif; ?>
                                ...
                                <?php if (!empty($testimonial['image'])): ?>
                                    <div class="author-image me-3">
                                        <img src="<?php echo SITE_URL . '/' . $testimonial['image']; ?>"
                                            alt="<?php echo $testimonial['name']; ?>" class="rounded-circle" width="60" height="60">
                                    </div>
                                <?php endif; ?>
                                <div class="author-info">
                                    <h5 class="mb-0"><?php echo $testimonial['name']; ?></h5>
                                    <p class="mb-0 text-muted"><?php echo $testimonial['position']; ?>,
                                        <?php echo $testimonial['organization']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion" id="faqAccordion">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                Our programs are designed for children between the ages of 7 and 14, with specific age
                                ranges for each program. We carefully tailor the content and teaching methods to suit
                                the developmental needs and abilities of each age group, ensuring that children are
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                No prior experience is necessary! Our programs are designed to accommodate beginners and
                                more experienced children alike. We start with the fundamentals and progress at a pace
                                that works for each child. Our instructors are skilled at meeting children where they
                                are and helping them advance their skills regardless of their starting point.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                All necessary equipment and materials are provided as part of the program fee. Your
                                child only needs to bring their enthusiasm and creativity! We recommend bringing a water
                                bottle and a snack for longer sessions. For some programs, children may want to bring a
                                USB drive to save their projects, although we also provide cloud storage options.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                We offer full refunds for cancellations made at least 14 days before the program start
                                date. Cancellations made 7-13 days before the start date receive a 50% refund.
                                Unfortunately, we cannot offer refunds for cancellations less than 7 days before the
                                program begins. However, we do allow transfers to another program or session if space is
                                available.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, we offer sibling discounts (10% off for each additional child) and early bird
                                registration discounts for programs booked at least one month in advance. We also have a
                                limited number of scholarships available for families who need financial assistance.
                                Please contact us directly to learn more about our scholarship program and eligibility
                                requirements.
                            </div>
                        </div>
                    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3 text-lg-end">
                <button type="button" class="btn btn-light btn-lg" data-bs-toggle="modal"
                    data-bs-target="#registerModal">Register Now</button>
            </div>
        </div>
    </div>
</section>
